...
function calcularSueldoNeto() {
  ...
  const tieneHijos = document.getElementById("conHijos").checked;
  ...
  if (!isNaN(sueldoBruto)) {
    ...
    // Mínimo no imponible y límite superior para aplicar la tabla
    const minimoNoImponibleSoltero = 1250000;
    const minimoNoImponibleCasadoConHijos = 1590062;
    ...
    let minimoNoImponible = tieneHijos ? minimoNoImponibleCasadoConHijos : minimoNoImponibleSoltero;
